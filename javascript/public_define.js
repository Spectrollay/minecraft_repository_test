...
const version_name_short = secondary_version_name + ".11"; // 例 4.0.0.1 // NOTE 小版本
...
const update_count = "2024-06-26-02"; // NOTE 小版本
let commit = "#2024062701"; // 例 #2024010101 , 仅留 # 则从 update_count 提取 // NOTE 有提交就变
if (commit === "#") {
